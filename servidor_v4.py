...
def asaas_criar_cliente_assinatura(uname, nome, email=""):
    ...
    payment_link = sub.get("paymentLink") or ("https://www.asaas.com/c/" + sub["id"])
    print(f"[ASAAS] Cliente: {customer_id} | Assinatura: {sub['id']} | Link: {payment_link}")
    return customer_id, sub["id"], payment_link
