...
- Para quem NÃO BATEU: liste 2-3 pontos_criticos baseados nos dados reais (ex: "conv de X% abaixo da média de Y%", "Z leads parados sem ação")
- Para cada ponto_critico, dê 1 solucao prática e específica (ex: "ligar para os 3 leads parados até sexta-feira")
- Seja direto, use números reais dos dados fornecidos, sem texto genérico"""
