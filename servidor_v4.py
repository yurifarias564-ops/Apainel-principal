...
def _enviar_alerta_email(assunto, corpo_html, tipo="alerta"):
    dest = ALERT_EMAIL or GMAIL_USER
    ...
    try:
        ...
        for uname in usuarios:
            ...
            for assunto, itens, cor in alertas:
                _enviar_alerta_email(assunto, _html_alerta(assunto, itens, cor))
...
def enviar_relatorio_manha():
    ...
    try:
        ...
        for uname in usuarios:
            ...
            _enviar_alerta_email(assunto, html, tipo="manha")
...
def enviar_relatorio_noite():
    ...
    try:
        ...
        for uname in usuarios:
            ...
            _enviar_alerta_email(assunto, html, tipo="semana")
...
class Handler(BaseHTTPRequestHandler):
    ...
    def render_admin(self, msg=""):
        ...
        if not users:
            ...
            clientes_html = "\n".join(parts)
        email_btn = (
            '<a href="/admin/emails" style="background:#1e3a8a;border:none;color:#fff;font-size:12px;' +
            'font-weight:700;padding:8px 14px;border-radius:7px;text-decoration:none;display:inline-flex;' +
            'align-items:center;gap:6px">📧 Gerenciar Emails</a>'
        )
        clientes_html = email_btn + '<div style="margin-top:20px"></div>' + clientes_html
